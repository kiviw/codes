...
class Codes:
    def __init__(self, generated_content=""):
        ...
        def extract_filename_from_code(code):
            ...
            file_name = file_name.lower().split("(")[0] + ".php"
            return file_name
        ...
        if generated_content != "":
            ...
            for match in matches:
                ...
                if "__main__" in code:
                    filename = "main.{}".format(code_type)
...
'''\n""" + unified_diff + "\n```"
    ...
    def _get_codes(self) -> str:
        ...
        for filename in self.codebooks.keys():
            ...
            content += "{}\n```{}\n{}\n```\n\n".format(filename, language, self.codebooks[filename])
        return content

    def _load_from_hardware(self, directory) -> None:
        assert len([filename for filename in os.listdir(directory) if filename.endswith((".php", ".py", ".html", ".js", ".css"))]) > 0
        for root, directories, filenames in os.walk(directory):
            for filename in filenames:
                if filename.endswith((".php", ".py", ".html", ".js", ".css")):
                    code_type = filename.split(".")[-1].lower()
    ...
    def _get_language(self, extension):
        ...
        return language_mapping.get(extension, "text")
